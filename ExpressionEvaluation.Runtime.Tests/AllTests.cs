...
public class AllTests
{
    ...
    public void Math_Operator_Add_Test()
    {
        ...
        Assert.Equal(4.5M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("1+3.5");
        Assert.Equal(4, expr2.Eval<int>());
    }
    ...
    public void Math_Operator_Subtract_Test()
    {
        ...
        Expression expr1 = new Expression("1-3.5");
        Assert.Equal(-2.5M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("1-3.5");
        Assert.Equal(-2, expr2.Eval<int>());

        Expression expr3 = new Expression("17769832984123423.82372423-17769832984123423.82372423");
        Assert.Equal(0, expr3.Eval<decimal>());

        Expression expr4 = new Expression("17769832984123423.82372423-1");
        Assert.Equal(17769832984123422.823724m, expr4.Eval<decimal>());
    }
    ...
    public void Math_Operator_Mul_Test()
    {
        ...
        Assert.Equal(7.2M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("2.4*-3.33");
        Assert.Equal(-7.992M, expr2.Eval<decimal>());

        Expression expr3 = new Expression("2785864653.34352334 * 6564653.35335343");
        Assert.Equal(18288235738559151.145413M, expr3.Eval<decimal>());
    }
    ...
    public void Math_Operator_Div_Test()
    {
        ...
        Assert.Equal(-0.720721M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("6/3");
        Assert.Equal(2M, expr2.Eval<decimal>());

        Expression expr3 = new Expression("5/3*3");
        Assert.Equal(5M, expr3.Eval<decimal>());
    }
    ...
    public void Math_Operator_Power_Test()
    {
        ...
        expr1.SetScale(3);
        Assert.Equal(0.102M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("2^3");
        Assert.Equal(8M, expr2.Eval<decimal>());

        Expression expr3 = new Expression("-2^2");
        Assert.Equal(-4M, expr3.Eval<decimal>());

        Expression expr4 = new Expression("3*2^-1.5^0.4%0.11-3");
        Assert.Equal(-2.992342M, expr4.Eval<decimal>());
    }
    ...
    public void Math_Operator_Mod_Test()
    {
        ...
        Assert.Equal(2M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("21%20");
        Assert.Equal(1M, expr2.Eval<decimal>());
    }
    ...
    public void Math_Unary_Operator_Test()
    {
        ...
        Assert.Equal(-8m, expr1.Eval<decimal>());
    ...
    public void Math_Operator_Precedence_Test2()
    {
        ...
        Assert.Equal(7.260356m, expr1.Eval<decimal>());

        expr1.SetFomular("6.78-2*3^-1.5+e/pi%3%(tan(pi/1.3)-0.12^-1.3/5)");
        expr1.SetScale(3);
        Assert.Equal(3.226m, expr1.Eval<decimal>());

        expr1.SetFomular("5/3*5^pi-1.32*-e%(-3.6*1.78)");
        expr1.SetScale(7);
        Assert.Equal(265.2423742m, expr1.Eval<decimal>());

        expr1.SetScale(6);
        expr1.SetFomular("PI()-+(--+---PI()/3*3)");
        Assert.Equal(6.283185m, expr1.Eval<decimal>());
    ...
    public void Math_Trigonometric_Test1()
    {
        ...
        Assert.Equal(1M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("SINH(PI()/2)");
        Assert.Equal(2.301299M, expr2.Eval<decimal>());

        Expression expr3 = new Expression("ASIN(0.5)");
        Assert.Equal(0.523599M, expr3.Eval<decimal>());

        Expression expr4 = new Expression("COS(PI())");
        Assert.Equal(-1m, expr4.Eval<decimal>());

        Expression expr5 = new Expression("COSH(4)");
        Assert.Equal(27.3082m, expr5.SetScale(4).Eval<decimal>());

        Expression expr6 = new Expression("ACOS(-0.5)*180/PI()");
        Assert.Equal(120m, expr6.SetScale(4).Eval<decimal>());

        Expression expr7 = new Expression("TANH(0)");
        Assert.Equal(0m, expr7.SetScale(4).Eval<decimal>());

        Expression expr8 = new Expression("TANH(-2)");
        Assert.Equal(-0.96403m, expr8.SetScale(5).Eval<decimal>());
    }
    ...
    public void Math_Trigonometric_Test2()
    {
        ...
        Assert.Equal(0.7854M, expr1.SetScale(4).Eval<decimal>());

        Expression expr2 = new Expression("ATAN(1)*180/PI()");
        Assert.Equal(45, expr2.Eval<int>());

        Expression expr2b = new Expression("ATAN(1)*180/PI()");
        Assert.Equal(45M, expr2b.Eval<decimal>());

        Expression expr3 = new Expression("DEGREES(ATAN(1))");
        Assert.Equal(45M, expr3.Eval<decimal>());

        Expression expr4 = new Expression("ATAN2(1, 1)");
        Assert.Equal(0.785398m, expr4.Eval<decimal>());

        Expression expr5 = new Expression("SEC(PI()/6)");
        Assert.Equal(1.1547m, expr5.SetScale(4).Eval<decimal>());

        Expression expr6 = new Expression("CSC(PI()/6)");
        Assert.Equal(2m, expr6.Eval<decimal>());

        Expression expr7 = new Expression("COT(PI()/6)");
        Assert.Equal(1.7321m, expr7.SetScale(4).Eval<decimal>());

        Expression expr8 = new Expression("ACOT(PI()/6)");
        Assert.Equal(1.088448m, expr8.Eval<decimal>());

        Expression expr9 = new Expression("COTH(PI()/6)");
        Assert.Equal(2.081283m, expr9.Eval<decimal>());

        Expression expr10 = new Expression("COTH(PI()*6)");
        Assert.Equal(1m, expr10.Eval<decimal>());
    }
    ...
    public void Math_Trigonometric_Test3()
    {
        ...
        Assert.Equal(0.57735m, expr2.Eval<decimal>());

        Expression expr2b = new Expression("MOD(16,3)");
        Assert.Equal(1, expr2b.Eval<int>());

        Expression expr3 = new Expression("MOD(6.25,1)");
        Assert.Equal(0.25M, expr3.Eval<decimal>());

        Expression expr4 = new Expression("LN(e)");
        Assert.Equal(1m, expr4.Eval<decimal>());

        Expression expr5 = new Expression("LN(10)");
        Assert.Equal(2.3026m, expr5.SetScale(4).Eval<decimal>());
    ...
    public void Math_Trigonometric_Test4()
    {
        ...
        Assert.Equal(20.085537M, expr1.Eval<decimal>());

        Expression expr2 = new Expression("ABS(-1.1)");
        Assert.Equal(1.1m, expr2.Eval<decimal>());

        Expression expr2b = new Expression("FACT(8)");
        Assert.Equal(40320, expr2b.Eval<int>());

        Expression expr3 = new Expression("PI()");
        Assert.Equal(3.14M, expr3.SetScale(2).Eval<decimal>());

        Expression expr4 = new Expression("RADIANS(180.5)");
        Assert.Equal(3.1503m, expr4.SetScale(4).Eval<decimal>());

        Expression expr5 = new Expression("DEGREES(PI())");
        Assert.Equal(180m, expr5.Eval<decimal>());

        Expression expr6 = new Expression("INT(123.4)");
        Assert.Equal(123, expr6.Eval<int>());
    ...
    public void Math_RoundCeil_Test()
    {
        ...
        Assert.Equal(3M, expr1.Eval<decimal>());

        expr1.SetFomular("CEILING(4.5, 1)");
        Assert.Equal(5M, expr1.Eval<decimal>());
        ...
        Assert.Equal(20.09M, expr1.Eval<decimal>());

        /* expr1.SetFomular("ROUND(20126.08,-1)");
         Assert.Equal(20130M, expr1.Eval<decimal>());*/
    ...
    public void Math_Combination_Test()
    {
        ...
        Assert.Equal(21.366845M, expr1.Bind("_a_", 3).Eval<decimal>());

        expr1.SetFomular("3^PI()^0.1");
        Assert.Equal(3.42758M, expr1.Eval<decimal>());
        ...
        Assert.Equal(9.559185m, expr1.Eval<decimal>());
    ...
    public void Math_E_Notation_Test()
    {
        ...
        Assert.Equal(1999m, expr1.Eval<decimal>());

        Expression expr2 = new Expression("-2e-3-1");
        Assert.Equal(-1.002m, expr2.Eval<decimal>());

        Expression expr3 = new Expression("2e+3-2e-3");
        Assert.Equal(1999.998m, expr3.Eval<decimal>());
    }
    ...
    public void Text_Concat_Test()
    {
        ...
        Assert.Equal("helloword", expr1.Eval<string>());

        Expression expr2 = new Expression("\"hello\"+1.5");
        Assert.Equal("hello1.5", expr2.Eval<string>());

        Expression expr3 = new Expression("\"hello\"+1.5");
        Assert.Equal("hello1.5", expr3.Eval<string>());

        Expression expr4 = new Expression("pi+\"hello\"");
        Assert.Equal("3.141593hello", expr4.Eval<string>());

        Expression expr5 = new Expression("\"hello\"&\"word\"");
        Assert.Equal("helloword", expr5.Eval<string>());

        Expression expr6 = new Expression("\"hel\"\"lo\"&123");
        Assert.Equal("hel\"lo123", expr6.Eval<string>());
    }
    ...
    public void Text_Function_left_right_Test()
    {
        ...
        Assert.Equal("he", expr1.Eval<string>());

        expr1.SetFomular("left(a,20)");
        Assert.Equal("helloword", expr1.Bind("a", "helloword").Eval<string>());

        expr1.SetFomular("right(\"helloword\",2)");
        Assert.Equal("rd", expr1.Eval<string>());
    ...
    public void Text_Function_Mid_Test()
    {
        ...
        Assert.Equal("ab", expr1.Eval<string>());

        expr1.SetFomular("MID(\"abcd\",2,1)");
        Assert.Equal("b", expr1.Eval<string>());

        expr1.SetFomular("MID(\"abcd\",1,20)");
        Assert.Equal("abcd", expr1.Eval<string>());

        expr1.SetFomular("MID(\"abcd\",-1,20)");
        Assert.Equal("", expr1.Eval<string>());
        ...
        Assert.Equal("d", expr1.Eval<string>());
        ...
        Assert.Equal("PrxLEiO3v2sb98NK9vgWVw6e6OYSuowaWMCSbQGYemqaieWP724mQYW7jTu2sLO", expr1.Eval<string>());

        expr1.SetFomular("LPAD(\"1\",10,\"0\")");
        Assert.Equal("0000000001", expr1.Eval<string>());

        expr1.SetFomular("RPAD(\"1\",10,\"0\")");
        Assert.Equal("1000000000", expr1.Eval<string>());

        expr1.SetFomular("RPAD(\"1\",10,\"\")");
        Assert.Equal("1", expr1.Eval<string>());

        expr1.SetFomular("RPAD(\"\",10,\"0\")");
        Assert.Equal("0000000000", expr1.Eval<string>());
    ...
    public void Text_Function_Reverse_Test()
    {
        ...
        Assert.Equal("dcba", expr1.Eval<string>());

        expr1.SetFomular("left(reverse(\"abcd\"),2)");
        Assert.Equal("dc", expr1.Eval<string>());
    ...
    public void Text_Function_LowerUpper_Test()
    {
        ...
        Assert.Equal("abc", expr1.Eval<string>());

        expr1.SetFomular("UPPER(\"aBc\")");
        Assert.Equal("ABC", expr1.Eval<string>());

        expr1.SetFomular("UPPER(\"neW york\")");
        Assert.Equal("NEW YORK", expr1.Eval<string>());
    }
    ...
    public void Text_Function_Trim_Rept_Test()
    {
        ...
        Assert.Equal("", expr6.Eval<string>());

        Expression expr7 = new Expression("REPT(a,5)");
        Assert.Equal("", expr7.Bind("a", null).Eval<string>());
    }
    ...
    public void Text_Function_Text_Test()
    {
        ...
        Assert.Equal("2", expr1.Eval<string>());

        expr1.SetFomular("TEXT(2.61,\"[hh]\")");
        Assert.Equal("62", expr1.Eval<string>());

        expr1.SetFomular("TEXT(2.61,\"hh-mm-ss\")");
        Assert.Equal("14-38-24", expr1.Eval<string>());

        expr1.SetFomular("TEXT(123.005)");
        Assert.Equal("123.005", expr1.Eval<string>());

        expr1.SetFomular("TEXT(1234.567,\"$#,##0.00\")");
        Assert.Equal("$1,234.57", expr1.Eval<string>());

        expr1.SetFomular("TEXT(0.285,\"0.0%\")");
        Assert.Equal("28.5%", expr1.Eval<string>());

        expr1.SetFomular("TEXT(122*100000,\"0.00E+00\")");
        Assert.Equal("1.22E+07", expr1.Eval<string>());

        expr1.SetFomular("TEXT(122*100000,\"uyfeg\")");
        Assert.Equal("uyfeg", expr1.Eval<string>());
    }
    ...
    public void Text_Function_Ascii_Test()
    {
        ...
        Assert.Equal("a", expr1.Eval<string>());

        expr1.SetFomular("CODE(\"a\")");
        Assert.Equal(97, expr1.Eval<int>());

        expr1.SetFomular("CODE(\"\t\")");
        Assert.Equal(9, expr1.Eval<int>());

        expr1.SetFomular("CHAR(0)");
        Assert.Equal("\0", expr1.Eval<string>());
    }
    ...
    public void Text_Function_Replace_Test()
    {
        ...
        Assert.Equal("ABC456", expr1.Eval<string>());

        expr1.SetFomular("REPLACE(\"123-455-3321\",\"-\",\"\")");
        Assert.Equal("1234553321", expr1.Eval<string>());

        expr1.SetFomular("REPLACE(\"123-455-3321\",\"-\",\"@\")");
        Assert.Equal("123@455@3321", expr1.Eval<string>());
    ...
    public void Text_Function_Find_Test()
    {
        ...
        Assert.Equal(11, expr1.Eval<int>());

        expr1.SetFomular("FIND(\"a\",\"ABCDabcABCabc\")");
        Assert.Equal(5, expr1.Eval<int>());

        expr1.SetFomular("FIND(\"\",\"ABCDabcABCabc\")");
        Assert.Equal(1, expr1.Eval<int>());
        ...
        Assert.Equal("HEWORD", expr1.Bind("name", "HELLO").Eval<string>());

        expr1.SetFomular("IF(SEARCH(\"A\",\"AEHABC\",4)>100,CONCAT(LEFT(name,2),\"WORD\"),\"N/A\")");
        Assert.Equal("N/A", expr1.Bind("name", "HELLO").Eval<string>());
    }
    ...
    public void Text_Function_Concat_Test()
    {
        ...
        Assert.Equal("abABCDabcABCabc", expr1.Eval<string>());

        expr1.SetFomular("CONCAT(\"\",\"ABCDabc\nAB;C\"\"abc\")");
        Assert.Equal("ABCDabc\nAB;C\"abc", expr1.Eval<string>());
    ...
    public void Literals_Operation_Test()
    {
        ...
        Assert.Equal(1.0509M, expr.Eval<decimal>());

        var expr2 = new Expression(formular).SetScale(4).SetWorkingCulture(new CultureInfo("es-ES"));
        Assert.Throws<OverflowException>(() => expr2.Eval<decimal>());
    }
